...
def check_team_access(
    data_base: orm.Session, team_id: int, user_id: int, need_lead: bool = False
):
...
def check_project_access(
    data_base: orm.Session, project_id: int, user_id: int, need_lead: bool = False
):
...
def check_stream_access(
    data_base: orm.Session, stream_id: int, user_id: int, need_lead: bool = False
):
    ...
    project_obj, user_team = check_project_access(
        data_base, stream_obj.project_id, user_id, need_lead=need_lead
    )
...
def check_task_access(
    data_base: orm.Session, task_id: int, user_id: int, need_lead: bool = False
):
    ...
    stream_obj, project_obj, user_team = check_stream_access(
        data_base, task_obj.stream_id, user_id, need_lead=need_lead
    )
