...
def create_custom_field_service(
    ...
    return custom_field_crud.create_custom_field(
        db=data_base, team_id=team_id, field=field_data
    )
...
def update_custom_field_service(
    data_base: orm.Session,
    field_id: int,
    user_id: int,
    ...
    db_field = (
        data_base.query(custom_field_model.CustomField)
    ...
    return custom_field_crud.update_custom_field(
        db=data_base, field_id=field_id, field_update=field_update
    )
