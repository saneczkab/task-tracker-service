...
def get_user_by_token(
    ...
    try:
        user_obj, teams = user_service.get_user_by_token_service(
            data_base, current_user.id
        )
...
def get_user(
    ...
    try:
        user_obj, teams = user_service.get_user_service(
            data_base, user_id, current_user.id
        )
