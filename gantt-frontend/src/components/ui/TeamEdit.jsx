                ...
                <List dense>
                  {teams.map((team, idx) => (
                    <Fragment key={team.id}>
                      ...
                      <Collapse in={expandedTeamIds.has(team.id)} unmountOnExit>
                        <Box
                          sx={{
                            bgcolor: "#EDEDED",
                            px: 2,
              ...
              >
                {addTeam.open ? (
                  <>
                    ...
                    <IconButton size="small" edge="end" onClick={createTeam}>
                      {addTeam.loading ? (
                        <CircularProgress size={20} />
                      ) : (
                  ...
                  <Button variant="text" size="small" onClick={startCreateTeam}>
                    Добавить команду
                  </Button>
                )}
              </Box>
